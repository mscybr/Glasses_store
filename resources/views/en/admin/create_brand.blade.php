                ...
                <div class="row">
                    <div class="col-lg-3">
                        <ul class="my-account-nav">
							<li><span class="my-account-nav-item active">Brands</span></li>
                        ...
                        <div class="my-account-content account-edit">
                            <div class="">
                                @if($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form class="" id="form-password-change"  method="POST" action="{{ route("brand_store") }}">
                                    @csrf
                                    <h6 class="mb_20">Add brand</h6>
                                    <div class="tf-field style-1 mb_15">
                                        <input value="{{old("brandName")}}" name="brandName" class="tf-field-input tf-input" placeholder=" " type="text" id="property1">
                                        <label class="tf-field-label fw-4 text_black-2" for="property1">Brand Name</label>
                                    </div>
                                    <div class="mb_20">
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr class="tf-cart-item file-delete">
                                        ...
                                        <td style="text-align: left"><form action="{{route("delete_brand")}}" method="post">
											@csrf
