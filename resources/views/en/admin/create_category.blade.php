                ...
                <div class="row">
                    <div class="col-lg-3">
                        <ul class="my-account-nav">
                            ...
                            <li><span class="my-account-nav-item active">Category</span></li>
                        ...
                        <div class="my-account-content account-edit">
                            <div class="">
                                @if($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form class="" id="form-password-change"  method="POST" action="{{ route("category_store") }}">
                                    @csrf
                                    <h6 class="mb_20">Add category </h6>
                                    <div class="tf-field style-1 mb_15">
                                        <input value="{{old("categoryName")}}" name="categoryName" class="tf-field-input tf-input" placeholder=" " type="text" id="property1">
                                        <label class="tf-field-label fw-4 text_black-2" for="property1">Category Name</label>
                                    </div>
                                    <div class="mb_20">
