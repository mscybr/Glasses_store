                ...
                <div class="row">
                    <div class="col-lg-3">
                        <ul class="my-account-nav">
                            ...
                            <li><span class="my-account-nav-item active">Lens</span></li>
                    ...
                    <div class="col-lg-9">
                        <div class="my-account-content account-edit">
                            <div class="">
                                @if($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form class="" id="form-password-change"  method="POST" action="{{ route("lens_store") }}">
                                    @csrf
                                    <h6 class="mb_20">Add lens </h6>
                                    <div class="tf-field style-1 mb_15">
                                        <input value="{{old("lensName")}}" name="lensName" class="tf-field-input tf-input" placeholder=" " type="text" id="property1">
                                        <label class="tf-field-label fw-4 text_black-2" for="property1">Lens Name</label>
                                    </div>
                                    <div class="mb_20">
                        ...
                        <table class="tf-table-page-cart">
                            <thead>
                                <tr>
                                    <th  style="text-align: left">Lens Name</th>
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr class="tf-cart-item file-delete">
                                        <td style="text-align: left">{{ $item->lensName }}</td>
                                        <td style="text-align: left">
                                            <form action="{{route("delete_lens")}}" method="post">
											@csrf
