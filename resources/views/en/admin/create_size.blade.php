...
@section("content")
	...
	<!-- Shoping Cart -->
	<form class="bg0 p-t-75 p-b-85" method="POST" action="{{ route("size_store") }}">
		@csrf
		<div class="container">
			<div class="row">
								...
								<div class="p-t-15">
									<div>
										...
										<div class="bor8 bg0 m-b-12">
											<input value="{{old("sizeName")}}" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="sizeName" placeholder="Name" required>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="m-l-25 m-r--38 m-lr-0-xl">
				<div class="wrap-table-shopping-cart">
					<table class="table-shopping-cart">
						<tr class="table_head">
							<th class="column-1">Size Name</th>
