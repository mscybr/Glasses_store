		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				<li>
					<a href="">Admin</a>
					<ul class="sub-menu-m">
						<li><a href="{{route("brand_form")}}">Brands</a></li>
					<li><a href="{{route("color_form")}}">Colors</a></li>
					<li><a href="{{route("size_form")}}">Sizes</a></li>
					<li><a href="{{route("lens_form")}}">Lenses</a></li>
					<li><a href="{{route("category_form")}}">Categories</a></li>
					<li><a href="{{route("subcategory_form")}}">Subcategories</a></li>
					</ul>
