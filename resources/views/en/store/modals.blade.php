    ...
    <div class="tf-toolbar-bottom type-1150">
        ...
        <div class="toolbar-item">
            <a href="{{route("favs")}}" >
                <div class="toolbar-icon">
                    ...
                    <div class="toolbar-count">{{ Cookie::get('favs') ? count( (array)json_decode( Cookie::get('favs')) ) : 0 }}</div>
                </div>
        ...
        <div class="toolbar-item">
            <a href="{{route("cart_items")}}">
                <div class="toolbar-icon">
                    <i class="icon-bag"></i>
                    <div class="toolbar-count">{{$orders}}</div>
                </div>
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-01.jpg")}} src={{asset("assets3/images/demo/home-01.jpg")}} alt="home-01">
                        ...
                        <div class="demo-item">
                            <a href="home-multi-brand.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-multi-brand.jpg")}} src={{asset("assets3/images/demo/home-multi-brand.jpg")}} alt="home-multi-brand">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                        ...
                        <div class="demo-item">
                            <a href="home-02.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-02.jpg")}} src={{asset("assets3/images/demo/home-02.jpg")}} alt="home-02">
                                    <div class="demo-label">
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-03.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-03.jpg")}} src={{asset("assets3/images/demo/home-03.jpg")}} alt="home-03">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-04.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-04.jpg")}} src={{asset("assets3/images/demo/home-04.jpg")}} alt="home-04">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-05.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-05.jpg")}} src={{asset("assets3/images/demo/home-05.jpg")}} alt="home-05">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-06.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-06.jpg")}} src={{asset("assets3/images/demo/home-06.jpg")}} alt="home-06">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-07.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-07.jpg")}} src={{asset("assets3/images/demo/home-07.jpg")}} alt="home-07">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-08.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-08.jpg")}} src={{asset("assets3/images/demo/home-08.jpg")}} alt="home-08">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-skincare.jpg")}} src={{asset("assets3/images/demo/home-skincare.jpg")}} alt="home-skincare">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-headphone.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-headphone.jpg")}} src={{asset("assets3/images/demo/home-headphone.jpg")}} alt="home-headphone">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-giftcard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-giftcard.jpg")}} src={{asset("assets3/images/demo/home-giftcard.jpg")}} alt="home-gift-card">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-furniture.jpg")}} src={{asset("assets3/images/demo/home-furniture.jpg")}} alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-furniture2.jpg")}} src={{asset("assets3/images/demo/home-furniture2.jpg")}} alt="home-furniture-2">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-skateboard.jpg")}} src={{asset("assets3/images/demo/home-skateboard.jpg")}} alt="home-skateboard">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-stroller.jpg")}} src={{asset("assets3/images/demo/home-stroller.jpg")}} alt="home-stroller">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-decor.jpg")}} src={{asset("assets3/images/demo/home-decor.jpg")}} alt="home-decor">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-electronic.jpg")}} src={{asset("assets3/images/demo/home-electronic.jpg")}} alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-setup-gear.jpg")}} src={{asset("assets3/images/demo/home-setup-gear.jpg")}} alt="home-setup-gear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-dog-accessories.jpg")}} src={{asset("assets3/images/demo/home-dog-accessories.jpg")}} alt="home-dog-accessories">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-kitchen.jpg")}} src={{asset("assets3/images/demo/home-kitchen.jpg")}} alt="home-kitchen-wear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-phonecase.jpg")}} src={{asset("assets3/images/demo/home-phonecase.jpg")}} alt="home-phonecase">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home_paddle_board.jpg")}} src={{asset("assets3/images/demo/home_paddle_board.jpg")}} alt="home-paddle_board">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-glasses.jpg")}} src={{asset("assets3/images/demo/home-glasses.jpg")}} alt="home-glasses">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-pod-store.jpg")}} src={{asset("assets3/images/demo/home-pod-store.jpg")}} alt="home-pod-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-activewear.jpg")}} src={{asset("assets3/images/demo/home-activewear.jpg")}} alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-handbag.jpg")}} src={{asset("assets3/images/demo/home-handbag.jpg")}} alt="home-handbag">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-tee.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-tee.jpg")}} src={{asset("assets3/images/demo/home-tee.jpg")}} alt="home-tee">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-socks.jpg")}} src={{asset("assets3/images/demo/home-socks.jpg")}} alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewerly.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-jewelry.jpg")}} src={{asset("assets3/images/demo/home-jewelry.jpg")}} alt="home-jewelry">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src={{asset("assets3/images/demo/home-sneaker.jpg")}} src={{asset("assets3/images/demo/home-sneaker.jpg")}} alt="home-sneaker">
                                </div>
    ...
    <div class="offcanvas offcanvas-start canvas-mb" id="mobileMenu">
        ...
        <div class="mb-canvas-content">
            <div class="mb-body">
                    ...
                    <li class="nav-mb-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse">
                            <ul class="sub-nav-menu" >
                                        <li><a class="sub-nav-link" href="{{route("brand_form")}}">Brand</a></li>
                                        <li><a class="sub-nav-link" href="{{route("color_form")}}">Color</a></li>
                                        <li><a class="sub-nav-link" href="{{route("lens_form")}}">Lens</a></li>
                                        <li><a class="sub-nav-link" href="{{route("size_form")}}">Size</a></li>
                                        <li><a class="sub-nav-link" href="{{route("subcategory_form")}}">Subcategory</a></li>
                                        <li><a class="sub-nav-link" href="{{route("category_form")}}">Category</a></li>
                                        <li><a class="sub-nav-link" href="{{route("site_config_form")}}">Site Confirgurations</a></li>
                                        <li><a class="sub-nav-link" href="{{route("product_form")}}">Product</a></li>
                                        <li><a class="sub-nav-link" href="{{route("inventory")}}">Inventory</a></li>
                                        <li><a class="sub-nav-link" href="{{route("orders")}}" >Orders</a></li>
                                </ul>
                            </div>
                        </li>
                    @endif
                ...
                <li class="nav-mb-item">
                    <a href={{route("shop")}}  class="collapsed mb-menu-link current" ><span>Shop</span>  </span></a>
                </li>
                <li class="nav-mb-item">
                    <a href="{{route("contact")}}"class="collapsed mb-menu-link current" ><span>About</span>  </span></a>
                </li>
                <li class="nav-mb-item">
                    <a href="{{route("contact")}}" class="collapsed mb-menu-link current" ><span>Contact</span>  </span></a>
                </li>
                <li class="nav-mb-item">
                    ...
                    <div id="dropdown-menu-two" class="collapse">
                        <ul class="sub-nav-menu" >
                            @guest
                                <li><a href="{{route("login")}}" class="sub-nav-link">Login</a></li>
                                <li><a href="{{route("register_form")}}" class="sub-nav-link">Register</a></li>
                            @endguest
                            @auth
                                <li><a href="{{route("profile")}}" class="sub-nav-link">Profile</a></li>
                                <li><a href="{{route("logout")}}" class="sub-nav-link">Logout</a></li>
                            @endauth
                        ...
                        <div class="tf-col-content">
                            ...
                            <div class="tf-search-hidden-inner">
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src={{asset("assets3/images/products/white-3.jpg")}} alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src={{asset("assets3/images/products/white-2.jpg")}} alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src={{asset("assets3/images/products/white-1.jpg")}} alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                ...
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src={{asset("assets3/images/shop/cate/cate1.jpg")}} alt="">
                            </div>
                    ...
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src={{asset("assets3/images/shop/cate/cate2.jpg")}} alt="">
                            </div>
                            <span>Dog</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src={{asset("assets3/images/shop/cate/cate3.jpg")}} alt="">
                            </div>
                            <span>Grocery</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src={{asset("assets3/images/shop/cate/cate4.png")}} alt="">
                            </div>
                            <span>Handbag</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
                            <div class="image">
                                <img src={{asset("assets3/images/shop/cate/cate5.jpg")}} alt="">
                            </div>
                            <span>Fashion</span>
                            <span class="btn-open-sub"></span>
                        </a>
                            ...
                            <ul class="sub-nav-menu" id="cate-menu-navigation">
                                <li>
                                    <a href="#cate-shop-one" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-one">
                                        <div class="image">
                                            <img src={{asset("assets3/images/shop/cate/cate6.jpg")}} alt="">
                                        </div>
                                        <span>Mens</span>
                                        <span class="btn-open-sub"></span>
                                    </a>
                                    <div id="cate-shop-one" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src={{asset("assets3/images/shop/cate/cate8.jpg")}} alt="">
                                                    </div>
                                                    <span>Shoes</span>
                                                </a>
                                            </li>
                                ...
                                <li>
                                    <a href="#cate-shop-two" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-two">
                                        <div class="image">
                                            <img src={{asset("assets3/images/shop/cate/cate9.jpg")}} alt="">
                                        </div>
                                        <span>Womens</span>
                                        <span class="btn-open-sub"></span>
                                    </a>
                                    <div id="cate-shop-two" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src={{asset("assets3/images/shop/cate/cate7.jpg")}} alt="">
                                                    </div>
                                                    <span>Tee</span>
                                                </a>
                                            </li>
                                ...
                                <div class="tf-compare-offcanvas">
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src={{asset("assets3/images/products/orange-1.jpg")}} alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src={{asset("assets3/images/products/pink-1.jpg")}} alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="wrap">
                    <div class="tf-product-info-item">
                        <div class="image">
                            <img src={{asset("assets3/images/products/orange-1.jpg")}} alt="">
                        </div>
                        <div class="content">
                    ...
                    <div class="tf-product-info-buy-button">
                        <form class="">
                            ...
                            <div class="w-100">
                                <a href="#" class="btns-full">Buy with <img src={{asset("assets3/images/payments/paypal.png")}} alt=""></a>
                    ...
                    <div class="tf-product-media-wrap">
                        <div class="swiper tf-single-slide">
                            <div class="swiper-wrapper" >
                                ...
                                <div class="swiper-slide">
                                    <div class="item">
                                        <img src={{asset("assets3/images/products/pink-1.jpg")}} alt="">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="tf-rte">
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload" data-src={{asset("assets3/images/shop/products/size_chart2.jpg")}} src={{asset("assets3/images/shop/products/size_chart2.jpg")}} alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Javascript -->
    <script type="text/javascript" src={{asset("assets3/js/bootstrap.min.js")}}></script>
    <script type="text/javascript" src={{asset("assets3/js/jquery.min.js")}}></script>
    <script type="text/javascript" src={{asset("assets3/js/swiper-bundle.min.js")}}></script>
    <script type="text/javascript" src={{asset("assets3/js/carousel.js")}}></script>
    <script type="text/javascript" src={{asset("assets3/js/bootstrap-select.min.js")}}></script>
    <script type="text/javascript" src={{asset("assets3/js/lazysize.min.js")}}></script>
    <script type="text/javascript" src={{asset("assets3/js/count-down.js")}}></script>   
    <script type="text/javascript" src={{asset("assets3/js/wow.min.js")}}></script>   
    <script type="text/javascript" src={{asset("assets3/js/multiple-modal.js")}}></script>
    <script type="text/javascript" src={{asset("assets3/js/main.js")}}></script>