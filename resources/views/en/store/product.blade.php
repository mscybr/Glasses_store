						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								...
								@foreach ($images as $thumb)
									...
									@endphp
										<div class="item-slick3" data-thumb="{{$image_src}}">
											<div class="wrap-pic-w pos-relative">
												<img src="{{$image_src}}" alt="IMG-PRODUCT">
		
												<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{$image_src}}">
									...
									<div class="p-b-30 m-lr-15-sm">
										...
										<div class="flex-w flex-t p-b-68">
											...
											@foreach ($reviews as $review)
												<div class="size-207 -r-18 m-t-20">
										...
										<!-- Add review -->
										<form class="w-full" action="{{route("add_review")}}" method="POST">
											@csrf
