...
<!-- Cart -->
	...
	<!-- Shoping Cart -->
	<form class="bg0 p-t-75 p-b-85" method="POST" action="{{ route("register") }}">
		@csrf
		<div class="container">
			<div class="row">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm m-lr-auto">
								...
								<div class="p-t-15">
									...
									<div class="bor8 bg0 m-b-12 d-flex">
										<input value="{{old("countryCode")}}" class="stext-111 cl8 plh3 size-111 p-lr-15 col-3" type="Number" name="countryCode" placeholder="+966" required>
										<input value="{{old("number")}}" class="stext-111 cl8 plh3 size-111 p-lr-15 col-9" type="Number" name="number" placeholder="5..." required>
									</div>
									<span class="stext-112 cl8">
										Enter Your Password
									</span>
									...
									<div class="bor8 bg0 m-b-12">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="password" name="password_confirmation" placeholder="Password Confirm" required>
									</div>
